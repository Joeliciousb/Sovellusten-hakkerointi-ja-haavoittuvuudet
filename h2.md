...
e) Korjasin projektin 020-your-eyes-only/logtin/hats/views.py tiedostosta AdminShowAllView return lauseketta. Aiemmin lausekkeesta puuttui self.request.user.is_staff, jonka vuoksi kaikki pääsivät katsomaan hakemiston palauttamaa näkymää. Korjauksen jälkeen localhost:8000/admin-console/ palauttaa 403 errorin mikäli ei ole admin oikeuksia. 
